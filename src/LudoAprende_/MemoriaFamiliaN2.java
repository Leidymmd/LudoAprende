 ...
 * @author Milena
 */
public class MemoriaFamiliaN2 extends javax.swing.JFrame {
    ...
    private void setCards(){
        ...
        btn1.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[0]+".png")));
        btn2.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[1]+".png")));
        btn3.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[2]+".png")));
        btn4.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[3]+".png")));
        btn5.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[4]+".png")));
        btn6.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[5]+".png")));
        btn7.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[6]+".png")));
        btn8.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[7]+".png")));
        btn9.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[8]+".png")));
        btn10.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[9]+".png")));
        btn11.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[10]+".png")));
        btn12.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[11]+".png")));
        btn13.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[12]+".png")));
        btn14.setDisabledIcon(new ImageIcon(getClass().getResource("../imagenesMemoriaf1/nivel1_"+numbers[13]+".png")));
    ...
    private void BotonSiguiente1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonSiguiente1ActionPerformed
        MemoriaFamiliaN3 memoriafamilia3 = new MemoriaFamiliaN3();
        memoriafamilia3.setVisible(true);
        this.setVisible(false);
