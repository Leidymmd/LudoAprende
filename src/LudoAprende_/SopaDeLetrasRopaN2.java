 ...
 * @author Milena
 */
public class SopaDeLetrasRopaN2 extends javax.swing.JFrame {
    JLabel letra[][];
    JLabel palabra[];
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Medias.png"))); // NOI18N

        Gif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Videos/SopaDeLetras.gif"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Pijama.png"))); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Gorro.png"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Bufanda.png"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Sombrero.png"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/zapatos.png"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Corbata.png"))); // NOI18N

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/gafas.png"))); // NOI18N

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/VestidoDeBaño.png"))); // NOI18N

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Guantes.png"))); // NOI18N
    ...
    private void SiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiguienteActionPerformed
        SopaDeLetrasRopaN3 CoctelDeLetrasRopaN3 = new SopaDeLetrasRopaN3();
        CoctelDeLetrasRopaN3 .setVisible(true);
        this.setVisible(false);
