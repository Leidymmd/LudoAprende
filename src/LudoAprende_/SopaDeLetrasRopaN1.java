 ...
 * @author Milena
 */
public class SopaDeLetrasRopaN1 extends javax.swing.JFrame {
    JLabel letra[][];
    JLabel palabra[];
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Camisa.png"))); // NOI18N

        Gif.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Videos/SopaDeLetras.gif"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Camiseta.png"))); // NOI18N

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Chaqueta.png"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Falda.png"))); // NOI18N

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Buso.png"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/vestido.png"))); // NOI18N

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/pantalon.png"))); // NOI18N

        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Panty.png"))); // NOI18N

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Pantaloncillos.png"))); // NOI18N

        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagenesRopa/Tenis.png"))); // NOI18N
    ...
    private void BotonVolverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotonVolverActionPerformed
        NivelesFamiliaMemoria nivelesRopaLetras = new NivelesFamiliaMemoria();
    ...
    private void SiguienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SiguienteActionPerformed
        SopaDeLetrasRopaN2 CoctelDeLetrasRopaN2 = new SopaDeLetrasRopaN2();
        CoctelDeLetrasRopaN2.setVisible(true);
        this.setVisible(false);
