...
public class NivelesFamiliaMemoria extends javax.swing.JFrame {

    /**
     * Creates new form NivelesFamiliaMemoria
     */
    public NivelesFamiliaMemoria() {
    ...
    private void Nivel1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Nivel1ActionPerformed
        MemoriaFamiliaN1 nivel1MemoriaFamilia= new MemoriaFamiliaN1();
        nivel1MemoriaFamilia.setVisible(true);
        this.setVisible(false);
    ...
    private void Nivel2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Nivel2ActionPerformed
        MemoriaFamiliaN2 nivel2MemoriaFamilia= new MemoriaFamiliaN2();
        nivel2MemoriaFamilia.setVisible(true);
        this.setVisible(false);
